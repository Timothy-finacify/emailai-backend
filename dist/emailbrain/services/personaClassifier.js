...
class PersonaClassifier {
     ...
     */
    static getRoleBasedPersona(role) {
     ...
     */
    static getSizeBasedPersona(companySize) {
        const sizeMapping = {
            micro: [
                {
                    personaType: "the_growth_obsessed_founder",
     ...
     */
    static getIndustryBasedPersona(industry) {
     ...
     */
    static getTopPersona(userProfile) {
     ...
     */
    static getPersonaCharacteristics(personaType) {
...
exports.PersonaClassifier = PersonaClassifier;
